			...
			<section class="[ action-buttons ][ xmall-12 ]">
				<div class="[ padding ]">
					<div class="[ row ]">
						<a href="/cart" class="[ button button--primary button--action ][ pull-left ]"><i class="[ icon-cart ]"></i></a>
						<a href="#" class="[ button button--primary button--action ][ pull-right ][ js-modal-opener ]" data-modal="nav"><i class="[ icon-menu ]"></i></a>
					</div>
				</div><!-- padding -->
